...
namespace Clinic
{
    public partial class frmSales : Form
    {
        ...
        {
            conn.Open();
            String sql4 = "SELECT mode_of_payment, SUM(amount)AS total_amount, SUM(discount) AS total_discount FROM payment AS t1 LEFT JOIN mode_of_payment AS t2 ON t1.mode_id = t2.mode_id GROUP BY description";
            MySqlDataAdapter da4 = new MySqlDataAdapter(sql4, conn);
            DataTable dt4 = new DataTable();
            da4.Fill(dt4);
            dgvSales.DataSource = dt4;
